...
export default function Page10_Scrapbook() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative py-20 px-4 bg-transparent text-[#4a4a4a] overflow-hidden">
        ...
        <div className="relative h-[600px] w-full flex items-center justify-center perspective-1000">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="absolute inset-0 bg-white rounded-r-3xl shadow-[20px_20px_60px_rgba(255,182,193,0.3)] border-2 border-pink-100 p-4 md:p-12 origin-left flex flex-col md:flex-row gap-8"
            >
              {/* Spine of the book */}
              <div className="absolute left-0 top-0 bottom-0 w-8 bg-pink-100 shadow-inner border-r border-pink-200 hidden md:block"></div>

              {/* Page Content */}
              <div className="md:ml-4 w-full h-full relative flex flex-col justify-between">
